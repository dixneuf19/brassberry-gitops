...
output "storage_ids" {
  ...
  value = {
    fastpool       = proxmox_storage_zfspool.fastpool.id
    tank_backups   = proxmox_storage_directory.tank_backups.id
    tank_iso       = proxmox_storage_directory.tank_iso.id
    tank_templates = proxmox_storage_directory.tank_templates.id
  }
}
